...
class TestBookRouter:
    ...
    @pytest.mark.integration
    def test_get_books_success(self, client, mock_student_token, sample_book_dict, mock_student_user):
        ...
        with patch('src.Services.bookService.BookService.RetrieveAllBooks') as mock_retrieve:
    ...
    @pytest.mark.integration
    def test_get_books_with_pagination(self, client, mock_student_token, sample_book_dict, mock_student_user):
    ...
    @pytest.mark.integration
    def test_get_book_by_id_found(self, client, mock_student_token, sample_book_dict, mock_student_user):
        """Test GET /books/{book_id} when book exists"""
        # Arrange
        book_id = sample_book_dict["id"]
        app.dependency_overrides[get_current_user] = lambda: mock_student_user
        
        with patch('src.Services.bookService.BookService.RetrieveBookById') as mock_retrieve:
            mock_retrieve.return_value = BookResponse(**sample_book_dict)
    ...
    @pytest.mark.integration
    def test_get_book_by_id_not_found(self, client, mock_student_token, mock_student_user):
    ...
    @pytest.mark.integration
    def test_create_book_success(self, client, mock_admin_token, sample_book_create_dict, sample_book_dict, mock_admin_user):
    ...
    @pytest.mark.integration
    def test_create_book_duplicate_isbn(self, client, mock_admin_token, sample_book_create_dict, mock_admin_user):
    ...
    @pytest.mark.integration
    def test_create_book_unauthorized_student(self, client, mock_student_token, sample_book_create_dict, mock_student_user):
    ...
    @pytest.mark.integration
    def test_update_book_success(self, client, mock_admin_token, sample_book_create_dict, sample_book_dict, mock_admin_user):
    ...
    @pytest.mark.integration
    def test_delete_book_success(self, client, mock_admin_token, sample_book_dict, mock_admin_user):
    ...
    @pytest.mark.integration
    def test_get_books_with_stats(self, client, mock_student_token, sample_book_dict, mock_student_user):
        ...
        with patch('src.Services.bookService.BookService.RetrieveBooksWithStats') as mock_retrieve:
