...
class TestBookBroker:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_all_books_success(self, broker, mock_supabase_client, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_book_by_id_found(self, broker, mock_supabase_client, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_book_by_isbn_found(self, broker, mock_supabase_client, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_insert_book_success(self, broker, mock_supabase_client, sample_book_create_dict, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_update_book_success(self, broker, mock_supabase_client, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_delete_book_success(self, broker, mock_supabase_client, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_search_books_found(self, broker, mock_supabase_client, sample_book_dict):
