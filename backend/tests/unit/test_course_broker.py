...
class TestCourseBroker:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_all_courses_success(self, broker, mock_supabase_client, sample_course_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_course_by_code_found(self, broker, mock_supabase_client, sample_course_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_courses_by_faculty(self, broker, mock_supabase_client, sample_course_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_insert_course_success(self, broker, mock_supabase_client, sample_course_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_update_course_success(self, broker, mock_supabase_client, sample_course_dict):
