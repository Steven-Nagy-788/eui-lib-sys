...
class TestUserService:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_all_users_success(
        self, service, mock_broker, sample_user_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_user_by_id_found(
        self, service, mock_broker, sample_user_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_add_user_duplicate_university_id(
        self, service, mock_broker, sample_user_dict
    ):
