...
class TestBookCopyBroker:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_all_copies_success(
        self, broker, mock_supabase_client, sample_copy_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_copies_by_book_id(
        self, broker, mock_supabase_client, sample_copy_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_copy_by_id_found(
        self, broker, mock_supabase_client, sample_copy_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_insert_copy_success(
        self, broker, mock_supabase_client, sample_copy_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_bulk_insert_copies(
        self, broker, mock_supabase_client, sample_copy_dict
    ):
