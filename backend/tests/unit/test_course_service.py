...
class TestCourseService:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_all_courses_success(self, service, mock_broker, sample_course_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_course_by_code_found(self, service, mock_broker, sample_course_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_add_course_duplicate_code(self, service, mock_broker, sample_course_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_modify_course_success(self, service, mock_broker, sample_course_dict):
