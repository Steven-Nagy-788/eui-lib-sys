...
class TestBookCopyService:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_all_copies_success(self, service, mock_broker, sample_copy_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_copies_by_book_id(self, service, mock_broker, sample_copy_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_copy_by_id_found(self, service, mock_broker, sample_copy_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_bulk_add_copies_success(self, service, mock_broker, sample_copy_dict):
