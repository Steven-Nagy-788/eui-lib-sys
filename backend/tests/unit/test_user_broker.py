...
class TestUserBroker:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_all_users_success(
        self, broker, mock_supabase_client, sample_user_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_user_by_id_found(
        self, broker, mock_supabase_client, sample_user_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_user_by_email_found(
        self, broker, mock_supabase_client, sample_user_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_user_by_university_id(
        self, broker, mock_supabase_client, sample_user_dict
    ):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_search_users_found(
        self, broker, mock_supabase_client, sample_user_dict
    ):
