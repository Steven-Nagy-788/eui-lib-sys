...
class TestLoanBroker:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_all_loans_success(self, broker, mock_supabase_client, sample_loan_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_loan_by_id_found(self, broker, mock_supabase_client, sample_loan_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_loans_by_user_id(self, broker, mock_supabase_client, sample_loan_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_select_loans_by_status(self, broker, mock_supabase_client, sample_loan_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_insert_loan_success(self, broker, mock_supabase_client, sample_loan_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_update_loan_success(self, broker, mock_supabase_client, sample_loan_dict):
