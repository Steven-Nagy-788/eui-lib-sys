...
class TestBookService:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_all_books_success(self, service, mock_broker, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_book_by_id_found(self, service, mock_broker, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_add_book_success(self, service, mock_broker, sample_book_create_dict, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_add_book_duplicate_isbn(self, service, mock_broker, sample_book_create_dict, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_modify_book_success(self, service, mock_broker, sample_book_create_dict, sample_book_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_modify_book_not_found(self, service, mock_broker, sample_book_create_dict):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_retrieve_books_with_stats_success(self, service, mock_broker, sample_book_dict):
