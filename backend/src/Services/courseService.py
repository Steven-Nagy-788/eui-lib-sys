...
class CourseService:
    ...
    async def RetrieveAllCourses(self, skip: int = 0, limit: int = 10) -> List[CourseResponse]:
    ...
    async def ModifyCourse(self, code: str, course_update: CourseUpdate) -> Optional[CourseResponse]:
        """Update a course"""
    ...
    async def RetrieveAllEnrollments(self, skip: int = 0, limit: int = 10) -> List[EnrollmentResponse]:
    ...
    async def RetrieveEnrollmentById(self, enrollment_id: UUID) -> Optional[EnrollmentResponse]:
    ...
    async def RetrieveEnrollmentsByStudent(self, student_id: UUID) -> List[EnrollmentResponse]:
        """Get all enrollments for a student"""
        enrollments = await self.broker.SelectEnrollmentsByStudent(student_id)
        return [EnrollmentResponse(**enrollment) for enrollment in enrollments]
    
    async def RetrieveEnrollmentsByCourse(self, course_code: str) -> List[EnrollmentResponse]:
    ...
    async def RemoveEnrollmentByStudentCourse(self, student_id: UUID, course_code: str) -> bool:
        """Remove student from a specific course"""
        return await self.broker.DeleteEnrollmentByStudentCourse(student_id, course_code)

    # ==================== COURSE BOOKS ====================
    
    async def RetrieveBooksForCourse(self, course_code: str) -> List[CourseBookResponse]:
