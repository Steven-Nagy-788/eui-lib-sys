...
class BookCopyService:
    ...
    async def RetrieveAllCopies(self, skip: int = 0, limit: int = 10) -> List[BookCopyResponse]:
    ...
    async def RetrieveCopyByAccessionNumber(self, accession_number: int) -> Optional[BookCopyResponse]:
    ...
    async def ModifyCopy(self, copy_id: UUID, copy_update: BookCopyUpdate) -> Optional[BookCopyResponse]:
    ...
    async def ModifyCopyStatus(self, copy_id: UUID, status: BookStatus) -> Optional[BookCopyResponse]:
